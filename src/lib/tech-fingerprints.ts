...
export const TECH_FINGERPRINTS: TechFingerprint[] = [
  ...
  },
  {
    ...
    patterns: {
      ...
      meta: [],
      html: [/class="[^"]*(?:container|row|col-|btn btn-|navbar|modal|carousel)/i],
  ...
  },
  {
    ...
    patterns: {
      ...
      scripts: [],
      meta: [],
      html: [/csrfmiddlewaretoken/i, /django/i, /__admin_media_prefix__/i],
      links: [],
    },
  },
  {
  ...
  // ═══════════════════════════════════════════════════════════════
  {
    ...
    patterns: {
      ...
      meta: [],
      html: [/firebase/i, /firebaseio\.com/i],
      links: [],
    },
  },
  {
  ...
  },
  {
    ...
    patterns: {
      ...
      scripts: [],
      meta: [],
      html: [/data-theme/i, /dark-mode/i, /color-scheme/i],
      links: [],
    },
  },
  {
